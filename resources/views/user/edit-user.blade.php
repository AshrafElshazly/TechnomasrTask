...
@section('content')
    <div class="col-12 grid-margin stretch-card">
        <div class="card">
            <div class="card-body">
                <h4 class="card-title">{{__('custom.editUser')}}</h4>
                <form class="forms-sample" method="POST" action="{{ url("admin/update-user/$user->id") }}"
                    ...
                    <div class="form-group">
                        ...
                        <input type="phone" class="form-control" id="exampleInputPhone" value="{{ $user->phone }}"
